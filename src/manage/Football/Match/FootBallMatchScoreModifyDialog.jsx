    ...
    getEventDetail = () => {
        ...
        const doms = {
            ...
            18: <div className="pt-m center">
                <div
                    onClick={onEventDetailSelect.bind(this, 0)}
                    className={currentEvent.key == 18 && this.state.remark == 0 ? "step-item-hover step-item-selected center" : "step-item-hover center"}>
                    <div style={{width: "78px", position: "relative"}}>
                ...
                <div
                    onClick={onEventDetailSelect.bind(this, 1)}
                    className={currentEvent.key == 18 && this.state.remark == 1 ? "step-item-hover step-item-selected center" : "step-item-hover center"}>
                    <div style={{width: "78px", position: "relative"}}>
