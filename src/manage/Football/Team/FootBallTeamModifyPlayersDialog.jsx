...
class FootBallTeamModifyPlayersDialog extends React.Component {
    state = {}
...
export default connect(mapStateToProps, mapDispatchToProps)(FootBallTeamModifyPlayersDialog);