...
class PaymentConfigModifyDialog extends React.Component {
    state = {}
                ...
                <Form>
                    ...
                    <FormItem {...formItemLayout} label="礼物" className="bs-form-item">
                        {getFieldDecorator('enableGift', {
                            initialValue: record.enableGift,
...
export default connect(mapStateToProps, mapDispatchToProps)(PaymentConfigModifyDialog);