...
class FootBallMatchScoreModifyDialog extends React.Component {
    ...
    initDraw = () => {
        ...
        this.setState({
            ...
            minute: this.props.record.minute,
    ...
    onEventSelect = (item, e) => {
        if (item !== this.state.event) {
            this.setState({event: item, currentChecked: true, remark: null, text: null});
        } else {
    ...
    getEventDetail = () => {
        ...
        const doms = {
            1: <div className="pt-m">
                ...
                <div className="center mt-s">
                    <Select defaultValue={this.state.remark} size="large" style={{minWidth: 150}}
            ...
            18: <div className="pt-m center">
                <div
                    onClick={onEventDetailSelect.bind(this, 0)}
                    className={currentEvent.key === 18 && this.state.remark === 0 ? "qz-live-step-item-hover qz-live-step-item-selected center" : "qz-live-step-item-hover center"}
                >
                    <div style={{width: "78px", position: "relative"}}>
                ...
                <div
                    onClick={onEventDetailSelect.bind(this, 1)}
                    className={currentEvent.key === 18 && this.state.remark === 1 ? "qz-live-step-item-hover qz-live-step-item-selected center" : "qz-live-step-item-hover center"}
                >
                    <div style={{width: "78px", position: "relative"}}>
        ...
        return <div>
            ...
            <div className="pt-s">
                {hideTime == true ? null : <Input defaultValue={this.state.minute ? this.state.minute : null}
            ...
            <div className="center w-full pl-l pr-l pt-s">
                <Input.TextArea defaultValue={this.state.text ? this.state.text : null}
                                rows={2} style={{maxWidth: "350px"}}
                                onChange={this.onTextChange}
                                className="center"
                                placeholder="请输入描述文字(不超过50字)"
                />
            </div>
        </div>
    };
    ...
    render() {
        ...
        return this.state.loading ? <div className="center">
            ...
            : <div className="qz-live-steps-div">
                <div className="qz-live-step-delete-item">
                    <Popconfirm
                        title={currentEvent === START || currentEvent === SECOND_HALF ? "将删除" + eventType[currentEvent].text + "的所有数据，确定?" : "确定要删除吗?"}
                        onConfirm={onDelete} onCancel={onDeleteCancel} okText="Yes" cancelText="No"
                    >
...
export default connect(mapStateToProps, mapDispatchToProps)(FootBallMatchScoreModifyDialog);